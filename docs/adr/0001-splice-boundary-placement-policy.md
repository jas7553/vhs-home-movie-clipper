...
- **Placement gets its own metric.** Add a human-eyeballed true-change second to the golden set for Splice Dead Zone boundaries only. No boundary-placement change merges without a measured median placement error.
